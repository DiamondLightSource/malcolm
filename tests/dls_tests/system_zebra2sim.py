...
class Zebra2SystemTest(unittest.TestCase):
    ...
    def test_poll(self):
        ...
        m = MagicMock()
        pulse0.add_listener(m, "attributes.WIDTH_UNITS")
        cothread.Sleep(0.2)
        self.assertEqual(m.call_args[0][0], pulse0.attributes["WIDTH_UNITS"])
