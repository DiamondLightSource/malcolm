...
class RunnableDevice(Device):
    ...
    def __init__(self, name):
        ...
        # Normal operations
        t(s.resettable(), e.Reset,    do.reset,     s.Fault, s.Idle)
    ...
    def do_reset(self, event):
        """Check and attempt to clear any error state, returning DState.Idle if
        everything is ok, or DState.Fault if not
        """
